        ...
        <div class="d-flex" style=" background-color: ">
            <div class="card col-sm-4"  style=" background-color: currentColor; ">
                <div class="card-body" style=" background-color: currentColor; ">
                    <form class="dark-form" action="Controlador?menu=Empleado" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label style="color: #fff">Foto Usuario:</label>
                    ...
                    <tbody style="background: currentColor;">
                        <c:forEach var="empleado" items="${empleados}">
                            <tr>
                                ...
                                <td style="color: #fff" align="center"><img src="ControladorFoto?vehiculo=Empleado&codigoEmpleado=${empleado.getCodigoEmpleado()}" onerror="this.src='img/vehiculonotfound.jpg'" width="100" height="80"></td>
