...
public class Conexion {
    ...
    public Connection Conexion() {
        try {
            ...
            //conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/DBAutoXpert?useSSL=false", "root", "1234");
            ...
            //conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/DBAutoXpert?useSSL=false", "Jonathan", "admin");
