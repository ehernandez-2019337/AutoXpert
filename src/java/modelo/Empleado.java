...
public class Empleado {
    ...
    public Empleado(int codigoEmpleado, String DPIEmpleado, String primerNombre, String otrosNombres, String apellidos, String telefonoEmpleado, String direccionEmpleado, boolean estadoEmpleado, String usuario, InputStream foto, int codigoSucursal, int codigoTipoEmpleado) {
