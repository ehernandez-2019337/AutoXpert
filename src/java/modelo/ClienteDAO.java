...
public class ClienteDAO {
    ...
    public List listar() {
        ...
        try{
            ...
            while(RS.next()){
                ...
                cliente.setDireccionCliente(RS.getString(6));
                cliente.setCorreoCliente(RS.getString(7));
                cliente.setEstadoCliente(RS.getBoolean(8));
                cliente.setCodigoTipoCliente(RS.getInt(9));
    ...
    public int actualizar(Cliente cliente){
        String sql = "UPDATE Cliente set nombres = ?, apellidos = ?, nit = ?, telefonoCliente = ?, direccionCliente = ?, correoCliente = ?, estadoCliente = ? WHERE codigoCliente = ?";
        try{
            con = cn.Conexion();
            PS = con.prepareStatement(sql);
            PS.setString(1, cliente.getNombres());
