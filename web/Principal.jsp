    ...
    <body>
        <nav class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                     <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline" href="Controlador?menu=Inventario&accion=Listar" target="myFrame">Inventario</a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" href="Controlador?menu=Inventario&accion=Carrito "><i class="fas fa-cart-plus"><label style="color: orange">${contador}</label></i>Carrito</a>
                     </li>
                </div>
            </div>
            <div class="dropleft">
                ...
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                    <div class="div-user">
                        <a class="dropdown-item" href="#">
                            <img src="ControladorFoto?vehiculo=Empleado&codigoEmpleado=${usuario.getCodigoEmpleado()}" alt="60" width="10"/>
                        </a>
                    </div>
                    <a class="dropdown-item" href="#">
                        ${usuario.getUsuario()}
